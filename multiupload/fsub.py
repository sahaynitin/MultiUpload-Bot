...
async def _(event):
	try:
		...
		await event.reply(f"Hey [{xx.first_name}]({xx.id}), I am **All in One Media Uploader Bot**", buttons=[
				Button.url('Support Chat 💭', 't.me/hxsupport') Button.url('Bots Channel ', 't.me/tellybots_4u
			])
